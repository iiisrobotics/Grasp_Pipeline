...
if("FALSE" STREQUAL "TRUE")
  set(robotiq_modbus_rtu_SOURCE_PREFIX /home/lsj/workspace/bulldog_ws/src/robotiq/robotiq_modbus_rtu)
  set(robotiq_modbus_rtu_DEVEL_PREFIX /home/lsj/workspace/bulldog_ws/devel)
  ...
  set(robotiq_modbus_rtu_INSTALL_PREFIX /home/lsj/workspace/bulldog_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robotiq_modbus_rtu' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lsj/workspace/bulldog_ws/install/${idir}'.  Ask the maintainer 'Shaun Edwards <sedwards@swri.org>, Kelsey Hawkins <kphawkins@gatech.edu>' to fix it.")
    endif()
