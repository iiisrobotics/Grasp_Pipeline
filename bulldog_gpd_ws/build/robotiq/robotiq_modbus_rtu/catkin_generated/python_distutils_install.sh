...
echo_and_run cd "/home/lsj/workspace/bulldog_ws/src/robotiq/robotiq_modbus_rtu"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/lsj/workspace/bulldog_ws/src/robotiq/robotiq_modbus_rtu/setup.py" \
    build --build-base "/home/lsj/workspace/bulldog_ws/build/robotiq/robotiq_modbus_rtu" \
    install \
    $DESTDIR_ARG \
